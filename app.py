...
def initialize_rag_chain():
    ...
    # 🚨 EK OOM ÖNLEMİ: Malloc yerine düşük hafıza tüketen bellek ayırıcı kullanmak
    # Render gibi kısıtlı ortamlarda OOM riskini azaltır.
    if 'PYTORCH_NO_CUDA_MEMORY_CACHING' not in os.environ:
        os.environ['PYTORCH_NO_CUDA_MEMORY_CACHING'] = '1'
    if 'MALLOC_CONF' not in os.environ:
        # Daha az bellek tüketen tcmalloc/jemalloc gibi araçların yerine geçer.
        os.environ['MALLOC_CONF'] = 'arena_max=2' # Örnek bir tweek
